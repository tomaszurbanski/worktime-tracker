...
const makeStyles = (C: Colors) => StyleSheet.create({
  ...
  delegationHeaderCard: { backgroundColor: C.delegationBg, borderRadius: 12, padding: 12, flexDirection: 'row', alignItems: 'center', gap: 10, borderWidth: 1, borderColor: C.delegationBorder, shadowColor: '#000', shadowOpacity: 0.04, shadowRadius: 4, elevation: 1, marginBottom: 4 },
    ...
    <View style={[styles.card, inDelegation && styles.cardIndented]}>
      ...
      <View style={styles.cardBody}>
        ...
        <View style={styles.badgeRow}>
          ...
          {isActive && <View style={[styles.badge, { borderColor: C.success + '40', backgroundColor: C.success + '15' }]}><Text style={[styles.badgeText, { color: C.success }]}>{t('common.active')}</Text></View>}
        </View>
      </View>
